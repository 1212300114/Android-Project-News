...
public class Constants {
    ...
    public static final String CHECK = "审查";
    public static final String WATCH = "巡视";
    public static final String IMAGE = "图闻";
    public static final String SUBJECT = "专题";
    public static final String EXPOSE = "曝光";
    public static String APPID = "wx967daebe835fbeac";
    public static String APPSECRET = "5595ea1667e58e486200553a";
    public static final int RET = 200;
