...
//各页详情内容
public class LooperViewDetailsActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // ���÷���ͼƬ, ����2ΪͼƬ��url��ַ
        mController.setShareMedia(new UMImage(LooperViewDetailsActivity.this,
                shareImage));
        // �ӷ��������ȥ���㲻��Ҫ�Ĳ���
        ...
        // ���΢��ƽ̨
        UMWXHandler wxHandler = new UMWXHandler(LooperViewDetailsActivity.this, appID,
                appSecret);
        wxHandler.addToSocialSDK();
        // ֧��΢������Ȧ
        UMWXHandler wxCircleHandler = new UMWXHandler(LooperViewDetailsActivity.this,
                appID, appSecret);
        ...
        UMQQSsoHandler qqSsoHandler = new UMQQSsoHandler(
                LooperViewDetailsActivity.this, "100424468",
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnBack:
                ...
                this.finish();
            case R.id.btnShare:
                mController.openShare(LooperViewDetailsActivity.this, false);
                // �����������
                break;
